    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 drop-shadow-lg">
          Little Breakfast 
          <span className="text-yellow-300 block md:inline"> Paradise </span>
        </h1>
       ...
       {/* <p className="text-xl md:text-2xl text-white mb-8 max-w-xl mx-auto drop-shadow-md">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          <button 
            ...
            className="bg-yellow-400 text-blue-900 hover:bg-yellow-500 mt-6 px-8 py-3 rounded-md font-semibold transition-colors"
          >
            View Menu
          </button>
        </div>
        ...
        <div className="flex justify-center space-x-8">
          <div className="flex flex-col items-center">
            <div className="bg-white/80 backdrop-blur-sm rounded-full p-3 mb-2 text-blue-800">
      ...
      <button 
        onClick={scrollToMenu}
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white hover:text-yellow-300 transition-colors animate-float"
      >
        <ChevronDown size={32} />
      </button>
    </section>

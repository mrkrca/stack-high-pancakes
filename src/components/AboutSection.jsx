      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            ...
            {/* Social Media Links */}
            <div className="mt-6 mb-6 text-center" data-aos="fade-up">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-5 mb-6 mt-5" data-aos="fade-up">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="rounded-lg overflow-hidden shadow-lg transform translate-y-6" data-aos="zoom-in">
                <img
              ...
              <div className="rounded-lg overflow-hidden shadow-lg" data-aos="zoom-in">
                <img
